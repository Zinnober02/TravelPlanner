...
public class WebIATWS extends WebSocketListener {
    ...
    private static final String appid = "ea4f4a9d";
    private static final String apiSecret = "OTMxMjU1MmE2NmI3MmUyNmQxNjJiNWRi";
    private static final String apiKey = "66ed0cadb85577717f41d6bd2b282dcc";
    ...
    public void onFailure(WebSocket webSocket, Throwable t, Response response) {
        ...
        try {
            if (null != response) {
                ...
                System.out.println(
                    "onFailure body:" + response.body().string()
                );
                if (101 != code) {
